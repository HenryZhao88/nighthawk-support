...
Live URL (once enabled): <https://henryzhao88.github.io/nighthawk-support>
...
1. Push this repository to GitHub. Make sure the repo is named `nighthawk-support` (or update the live URL to match your repo).
...
2. Name it (e.g. `nighthawk-support`). Google Analytics is optional.
